...
public class CorsFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext,
        ...
        if (allowCredentials)
            responseContext.getHeaders().putSingle(CorsHeaders.ACCESS_CONTROL_ALLOW_CREDENTIALS,
                    "true");
    ...
    protected void preflight(String origin, ContainerRequestContext requestContext)
        ...
        String requestMethods =
                requestContext.getHeaderString(CorsHeaders.ACCESS_CONTROL_REQUEST_METHOD);
